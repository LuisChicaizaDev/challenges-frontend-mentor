export const Footer = () => {
    return (
        <footer className="max-w-100 m-auto text-center py-8 px-2">
            <a href="https://frontend-mentor-luis.vercel.app/" className="inline-block my-10 border bg-gray-100 border-gray-300 py-2 px-4 rounded-md text-center text-sm text-gray-700 hover:bg-gray-200 hover:text-blue-500 transition">

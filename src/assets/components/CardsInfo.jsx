...
export const CardsInfo = () => {
    return (
        <section className='grid grid-cols-1 gap-4 md:grid-cols-3'>
            ...
            <div className='flex flex-col gap-4 justify-between p-8 bg-white border border-gray-300 rounded-xl dark:bg-slate-800 dark:border-slate-600'>
                <div className='flex justify-between'>
                    <h3 className='text-xl dark:text-white'>Desafíos Completados</h3>
                    <LaptopMinimalCheck className='text-gray-500 size-7 dark:text-gray-400'/>
                </div>
                <div>
            ...
            <div className='flex flex-col gap-4 justify-between p-8 bg-white border border-gray-300 rounded-xl dark:bg-slate-800 dark:border-slate-600'>
                <div className='flex justify-between'>
                    ...
                    <CodeXml className='text-gray-500 size-7 dark:text-gray-400'/>
                </div>
                <div>
            ...
            <div className='flex flex-col gap-4 justify-between p-8 bg-white border border-gray-300 rounded-xl dark:bg-slate-800 dark:border-slate-600'>
                <div className='flex justify-between'>
                   ...
                   <a href="#" target='_blank'>
                        <ExternalLink className='text-gray-500 size-7 hover:text-gray-400 transition-colors dark:text-gray-400 dark:hover:dark:text-gray-300'/>
                   </a>
                </div>
                <div>
